package games.bevs.library.modules.protocol.packet.types;
...
public class BaseBlockPosition extends NMSObject {
    ...
    private static FieldAccessor<Integer> fieldX = fetchField(NMSObject.Type.BASEBLOCKPOSITION, int.class, 0);
