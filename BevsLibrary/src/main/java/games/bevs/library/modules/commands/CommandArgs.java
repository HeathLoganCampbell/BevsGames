...
public class CommandArgs {
	...
	protected CommandArgs(CommandSender sender, org.bukkit.command.Command command, String label, String[] args,
			int subCommand, PlayerDataHandler playerDataHandler) {
	...
	{
		if(this.playerDataHandler == null) return null;
		if(this.playerDataHandler.getPlayerDataManager() == null) return null;
		if(this.getPlayer() == null) return null;
		return this.playerDataHandler.getPlayerDataManager().getPlayerData(this.getPlayer());
	}
}
